...
class NameDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<Name> _instance;
} _Name_default_instance_;
}  // namespace YellowPages
static void InitDefaultsName_name_2eproto() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_Name_name_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsName_name_2eproto}, {}};

void InitDefaults_name_2eproto() {
  ::google::protobuf::internal::InitSCC(&scc_info_Name_name_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_name_2eproto[1];
const ::google::protobuf::EnumDescriptor* file_level_enum_descriptors_name_2eproto[1];
constexpr ::google::protobuf::ServiceDescriptor const** file_level_service_descriptors_name_2eproto = nullptr;

const ::google::protobuf::uint32 TableStruct_name_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::YellowPages::_Name_default_instance_),
};

::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_name_2eproto = {
  {}, AddDescriptors_name_2eproto, "name.proto", schemas,
  file_default_instances, TableStruct_name_2eproto::offsets,
  file_level_metadata_name_2eproto, 1, file_level_enum_descriptors_name_2eproto, file_level_service_descriptors_name_2eproto,
};

const char descriptor_table_protodef_name_2eproto[] =
  ...
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_name_2eproto = {
  false, InitDefaults_name_2eproto, 
  descriptor_table_protodef_name_2eproto,
  "name.proto", &assign_descriptors_table_name_2eproto, 136,
};
...
void AddDescriptors_name_2eproto() {
 ...
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_name_2eproto, deps, 0);
}

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_name_2eproto = []() { AddDescriptors_name_2eproto(); return true; }();
namespace YellowPages {
const ::google::protobuf::EnumDescriptor* Name_Type_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&assign_descriptors_table_name_2eproto);
...
const Name_Type Name::MAIN;
const Name_Type Name::SYNONYM;
const Name_Type Name::SHORT;
const Name_Type Name::Type_MIN;
const Name_Type Name::Type_MAX;
const int Name::Type_ARRAYSIZE;
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int Name::kValueFieldNumber;
const int Name::kTypeFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
const char* Name::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<Name*>(object);
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("YellowPages.Name.value");
      ...
      case 2: {
        ...
        msg->set_type(static_cast<::YellowPages::Name_Type>(val));
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        break;
      }
      default: {
...
// @@protoc_insertion_point(generalized_merge_from_start:YellowPages.Name)
  ...
  const Name* source =
      ::google::protobuf::DynamicCastToGenerated<Name>(
          &from);
  if (source == nullptr) {
...
::google::protobuf::Metadata Name::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_name_2eproto);
  return ::file_level_metadata_name_2eproto[kIndexInFileMessages];
}
